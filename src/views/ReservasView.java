...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {
		if(txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null 
			...
			Reservas reserva = new Reservas(dataE, dataS, txtValor.getText(), txtFormaPago.getSelectedItem().toString());
	...
	//Permite actualizar las fechas en la tabla
